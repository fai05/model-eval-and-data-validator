...
st.markdown(
    "<h1 style='text-align: center; color: #2F4F4F; font-family: sans-serif;'>Hydrological Input Data Validator</h1>",
    unsafe_allow_html=True,
)
st.markdown("---")
...
if uploaded_file is not None:
    ...
    st.download_button("Download Full Flagged Data as CSV", data=csv, file_name=f"{selected_var}_validated.csv", mime='text/csv')
