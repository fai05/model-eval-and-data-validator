...
st.set_page_config(page_title="Discharge Evaluation Tool", layout="wide")
st.markdown("""
<style>
...
<div style='width:100%; display:flex; justify-content:center;'>
  <div style='min-width:320px; max-width:400px; margin:auto;'>
    <div id='radio-center'>
    </div>
  </div>
</div>
""", unsafe_allow_html=True)
# Place the radio directly after the centering div so it appears centered
input_fmt = st.radio("", ["CSV files", "Pickle file"], horizontal=True, label_visibility="collapsed", key="input_radio_centered")
st.markdown("---")
